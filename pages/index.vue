  ...
  <div class="pb-8 md:pb-24 lg:pb-48">
    ...
    >
      ...
      <p class="mt-2 text-lg md:text-xl">
        prof. Pavel Šámal, předseda Nejvyššího soudu
      </p>
    </div>
    <div class="flex flex-row">
      ...
      >
        ...
        <section class="profile-section">
          ...
          >
            <AverageDecisionDuration id="avg-decision-duration" class="chart" />
            <LongestDecisionTime id="longest-decision-time" class="chart" />
            <DecisionTimeHistogram id="decision-time-histogram" class="chart" />
          </div>
        </section>
        <section class="profile-section">
            ...
            <ul class="list-disc list-outside ml-5">
              ...
              <li>
                <a
                  ...
                  rel="noopener"
                  class="underline"
                  >usnesení OS Praha 1 o zastavení trestního stíhání ze dne 27.
                  6. 2014</a
                >
                (Pohůnek)
              </li>
          ...
          >
            <ul class="list-disc list-outside ml-5">
              ...
              <li>
                ...
                >
                MS Praha ze dne 4. 4. 2017 &mdash; Rozhodnutí bylo zrušeno jako
                nezákonné a MS Praha zároveň nařídil, aby byla věc projednána
                jiným soudcem
              </li>
              <li>
                <a
            ...
            <ul class="list-disc list-outside ml-5">
              <li>
                <a
                  ...
                  rel="noopener"
                  class="underline"
                  >odsuzující rozsudek OS Praha 1 ze dne 20. 6. 2002, sp. zn. 8
                  T 162/97</a
                >
                (J. C.)
              </li>
              <li>
                <a
                  ...
                  rel="noopener"
                  class="underline"
                  >odsuzující rozsudek OS Praha 1 ze dne 25. 2. 2004, sp. zn. 3
                  T 92/2002</a
                >
                (J. M.)
              </li>
              <li>
                <a
                  ...
                  rel="noopener"
                  class="underline"
                  >odsuzující rozsudek OS Praha 1 ze dne 2. 12. 2004, , sp. zn.
                  3 T 41/2004</a
                >
                (J. S., M. B., J. H.)
              </li>
              ...
              <li>
                <a
                  ...
                  rel="noopener"
                  class="underline"
                  >odsuzující a zprošťující rozsudek OS Praha 1 ze dne 13. 10.
                  2005, sp. zn. 3 T 41/2004</a
                >
                (J. S., J. H., M. B.)
              </li>
              <li>
              ...
              <li>
                <a
                  ...
                  rel="noopener"
                  class="underline"
                  >zproštění J. S. a J. H. a odsouzení J. S. rozsudkem OS Praha
                  1 ze dne 13. 4. 2006, sp. zn. 3 T 34/2006</a
                >
              </li>
              <li>
                <a
        ...
        <section class="profile-section">
          ...
          <DisciplinaryOffense year="2018">
            ...
            &mdash; na základě kárné žaloby ministra spravedlnosti JUDr. Roberta
            Pelikána, Ph.D., uznána Nejvyšším správním soudem vinnou, že z
            nedbalosti v rozporu se závaznými právními názory odvolacího soudu
            hodnotila důkazy způsobem jsoucím v extrémním rozporu s rozumným
            myšlením, za což jí bylo uloženo kárné opatření ve formě snížení
